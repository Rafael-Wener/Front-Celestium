    ...
    return (
        ...
        <div className="bg-white flex flex-col w-full items-start px-40">
            ...
            <div className="flex gap-4 bg-[#140b2b] w-full p-10 rounded-2xl shadow-black shadow-[2px_2px_10px_2px] mt-15 items-center justify-center">
                ...
                <div className="flex flex-row items-center justify-center ml-90 bg-purple-700 rounded-md h-10 w-47 hover:bg-purple-600 transition-all hover:scale-105">
                    <img src="/usuario.png" alt="icone de usuario" className="h-4 w-4 invert m-2 font-bold" />
                    <button className="flex font-bold">Entrar na conta</button>
                </div>
                
                    {/* BOTAO DE CADASTRAR NO CONTAINER */}
                    <div>
                    <div className="flex flex-row items-center justify-center bg-purple-950/40 rounded-md h-10 w-47 border border-purple-900 hover:bg-purple-800/40 hover:border-purple-800 transition-all hover:scale-105">
                        <img src="/adicionar-usuario.png" alt="icone de cadastrar usuario" className="h-5 w-5 invert m-2" />
                        <button className="font-bold font-sans">Criar cadastro</button>
                    </div>
                </div>
            </div>
