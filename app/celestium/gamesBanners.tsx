    ...
    return (
        ...
        <div className="bg-white flex flex-col w-full items-start px-40">
            ...
            <div className="flex gap-4 bg-[#140b2b] w-full p-10 rounded-2xl shadow-black shadow-[2px_2px_10px_2px] mt-15 items-center justify-center">
                ...
                <div className="flex flex-row items-center justify-center ml-90 bg-purple-700 rounded-md h-10 w-47">
                    ...
                    <div>
                    <div className="flex flex-row items-center justify-center bg-purple-950/40 rounded-md h-10 w-47 border border-purple-900">
