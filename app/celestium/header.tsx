export default function HeaderCelestium() {
  return (
    // TELA BACKGROUND
    <div className="w-screen h-screen flex items-start px-40 bg-gradient-to-b from-purple-950/40 to-black p-20">
      {/* TELA HOME WRAPPER */}
      <div className=" flex flex-col items-start justify-center">
        {/* SLOGAN HOME */}
        <h1 className="text-white text-6xl font-bold">A loja oficial do</h1>
        <span className="bg-gradient-to-r from-purple-500 to-blue-400 bg-clip-text text-transparent text-6xl font-bold">
          CelestiumMC
        </span>
        ...
        <div className="flex flex-row items-center justify-center gap-6">
          {/* DISCORD BUTTON */}
          <button className="bg-purple-500 hover:bg-purple-600 text-white font-bold flex items-center py-3 px-6 rounded-md mt-6 gap-4">
