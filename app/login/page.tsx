    ...
    <div className="min-h-screen w-full bg-[#080011] text-white overflow-hidden relative">
      ...
      <div className="relative z-10 min-h-screen grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex flex-col items-center justify-center px-6">
          <div className="border border-purple-500/30 shadow-[0_0_45px_rgba(126,34,206,0.25)] flex flex-col bg-zinc-950/70 backdrop-blur-md h-auto w-full max-w-[480px] rounded-2xl px-8 py-10">
            ...
            <div className="flex justify-between items-center mt-5 text-sm">
              ...
              <a href="#" className="text-purple-400 hover:text-purple-300 duration-300">
                Esqueci minha senha
              </a>
            </div>
